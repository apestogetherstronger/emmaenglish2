import { createGame } from './game.js?v=2.3.0';
...
export function createState() { return { version: 2, settings: { ...DEFAULT_SETTINGS }, answers: [], sessions: [], speaking: [], game: createGame(), xp: 0 }; }
